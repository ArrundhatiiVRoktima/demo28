...
function submit(){
    ...
    if (first_name_input == "" || gender == "" || full_dob=="") {
        ...
        if(psychic_number == "1" && destiny_number == "1"){
            document.getElementById("pd_combination_description").textContent = "You have a very good combination of Psychic number and Destiny number. You are a born leader. Your ego is a little high. You are a self-sufficient person and you don't need any kind of support system in your life. You have a royal and king-like attitude. You want to be the only boss in your life. You are fiercely independent, competitive and determined in nature, you value your freedom. You have leadership qualities and you are self reliant. You always accomplish whatever you have set in your mind. You are perpetually brimming with new ideas and this is what gives you happiness. You have a charismatic personality and you can magically draw everyone's attention to yourself, even in a large crowd. You hate to be overlooked by anyone. You need to drop that arrogance and dominating tendency with others."
        ...
        if(psychic_number == "1" && destiny_number == "2"){
            document.getElementById("pd_combination_description").textContent = "You have a good combination of Psychic number and Destiny number. You are a born leader. Your ego is a little high but you don't show it to others. You have good leadership qualities and you are self reliant. You always accomplish whatever goals you set for yourself. You are perpetually brimming with new ideas and this is what gives you happiness. You have a charismatic personality and you can magically draw everyone’s attention to yourself even in a large crowd. You sound very cool. You have a flickering mind set up, meaning your mood changes and fluctuates a lot. You are sensitive in nature. Intuition, kindness, thoughtfulness, and delicacy are all your characteristics. However, one of the most significant characteristics you possess is the ability to adapt to various conditions and circumstances."
            document.getElementById("lucky_no").textContent = "Lucky No. : 1, 3, 5, 6"
